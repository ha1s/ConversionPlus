...
Процедура ДобавитьЭлемент(Имя, Значение)
	...
	Стр = СокрЛП(XMLСтрока(Значение)); //bn
...
Процедура ВыгрузитьРеквизитыКонвертации()
	...
	ДобавитьЭлемент("ДатаВремяСоздания", bnГитфлоу.ВернутьСтрокуВыгрузки_ДатаОбновления(КонвертацияДляВыгрузки.ДатаОбновления)); //bn
