...
Процедура ОбработкаПроверкиЗаполненияНаСервере(Отказ, ПроверяемыеРеквизиты)
	...
	Если Не ЭтоКлиент Тогда
		...
		ПроверяемыеРеквизиты.Добавить("ИмяФайлаВыгрузки");
...
Процедура Выгрузить(Команда)
	...
	Если ВыполнитьВыгрузкуНаСервере(АдресФайла) Тогда
		...
		Сообщить("Выгрузка описания структуры конфигурации успешно завершена.");
...
Процедура ИзменитьРежимОбработки()
	...
	Элементы.ИмяФайлаВыгрузки.Доступность = Не ЭтоКлиент;
